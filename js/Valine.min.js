    ...
    r.prototype.Q = function (e) {
      ...
      var B = function () {
        ...
        N = function () {
		  ...
		  let nickname = document.getElementsByClassName("vnick vinput")[0].value;
		  let email = document.getElementsByClassName("vmail vinput")[0].value;
		  let emailpattern = /^([A-Za-z0-9_\-\.])+\@([A-Za-z0-9_\-\.])+\.([A-Za-z]{2,4})$/;
		  if(!emailpattern.test(email) || !nickname || !email){
			Swal.fire("格式错误","请输入昵称或者正确的邮箱地址","info");  
			u.removeAttr(P, "disabled"),t.loading.hide();
			return;
		  }
